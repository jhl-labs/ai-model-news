...
주요 기관이 최근 30일 안에 공개한 신작입니다. 이 기준에 해당해 선정했습니다. 좋아요 83개, 다운로드 10,278회(수집 시점 2026-09-05). 이전 모델 tencent/WeMM-Embedding-9B(파라미터 9.4B, 다운로드 3,360) 대비 이번 모델은 파라미터 71.3% 감소, 다운로드 205.9% 증가, 라이선스 동일(other).
