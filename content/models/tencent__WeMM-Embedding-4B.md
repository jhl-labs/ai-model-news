...
주요 기관이 최근 30일 안에 공개한 신작입니다. 이 기준에 해당해 선정했습니다. 좋아요 32개, 다운로드 1,880회(수집 시점 2026-09-05). 이전 모델 tencent/WeMM-Embedding-9B(파라미터 9.4B, 다운로드 3,360) 대비 이번 모델은 파라미터 44.7% 감소, 다운로드 44.0% 감소, 라이선스 동일(other).
