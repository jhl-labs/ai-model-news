...
hf_url: "https://huggingface.co/microsoft/VibeVoice-ASR-Streaming-1.5B"
...
주요 기관이 최근 30일 안에 공개한 신작입니다. 이 기준에 해당해 선정했습니다. 좋아요 28개, 다운로드 420회(수집 시점 2026-09-05). 이전 모델 microsoft/VibeVoice-ASR-Streaming-7B(파라미터 8.7B, 다운로드 573) 대비 이번 모델은 파라미터 67.8% 감소, 다운로드 26.7% 감소, 라이선스 동일(mit).
