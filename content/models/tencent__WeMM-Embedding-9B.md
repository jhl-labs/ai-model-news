...
주요 기관이 최근 30일 안에 공개한 신작입니다. 이 기준에 해당해 선정했습니다. 좋아요 114개, 다운로드 3,360회(수집 시점 2026-09-05). 이전 모델 tencent/WeMM-Embedding-4B(파라미터 5.2B, 다운로드 1,880) 대비 이번 모델은 파라미터 80.8% 증가, 다운로드 78.7% 증가, 라이선스 동일(other).
...
- [WeMM Embedding 2B](../tencent__WeMM-Embedding-2B/)
